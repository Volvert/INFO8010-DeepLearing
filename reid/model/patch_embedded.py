...
see: https://docs.pytorch.org/docs/2.11/generated/torch.nn.Embedding.html
...
class PatchEmbedding(nn.Module):
    ...
    Input  : (B, C, H, W) -> (64, 3, 224, 224)
    Output : (B, num_patches, d_model) -> (64, 196, 192)
    ...
    def __init__(
        ...
        But Conv2d does it in one GPU operation.
        """
        self.proj = nn.Conv2d(
